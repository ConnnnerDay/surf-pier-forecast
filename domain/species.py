...
_SPECIES_CATEGORIES: Dict[str, List[str]] = {
    ...
    "Eulachon (smelt)": ["panfish", "baitfish"],
    ...
    "Banded rudderfish": ["game_fish", "baitfish"],
    "Bar jack": ["game_fish"],
    ...
    "Nenue (chub)": ["panfish"],
    "Amaama (striped mullet, Hawaii)": ["panfish", "baitfish"],
    ...
    "Sandbar shark": ["catch_and_release"],
