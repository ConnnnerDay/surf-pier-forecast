...
_SPECIES_CATEGORIES: Dict[str, List[str]] = {
    ...
    "Striped marlin": ["game_fish", "pelagic", "catch_and_release"],
    "Pacific sailfish": ["game_fish", "catch_and_release"],
    # Atlantic offshore pelagics
    "Wahoo (Atlantic)": ["game_fish"],
    "Blue marlin": ["game_fish", "pelagic", "catch_and_release"],
    ...
    "Lemon shark": ["shark", "catch_and_release"],
    "Nurse shark": ["shark", "catch_and_release"],
    # Inshore highlights
