...
_SPECIES_CATEGORIES: Dict[str, List[str]] = {
    ...
    "Pile perch": ["panfish"],
    "Shiner perch": ["panfish", "bait_fish"],
    ...
    "Scaled sardine (pilchard)": ["bait_fish"],
    # New East Coast species
    "Atlantic silverside": ["bait_fish", "panfish"],
    "Sea raven": ["panfish"],
    "Lumpfish": ["panfish"],
    ...
    "Bay anchovy": ["bait_fish"],
    "Mummichog": ["bait_fish", "panfish"],
    "Striped killifish": ["bait_fish", "panfish"],
    ...
    "Pacific mackerel": ["game_fish", "bait_fish"],
    "Jack mackerel (Pacific)": ["game_fish", "bait_fish"],
    "Surf smelt": ["panfish", "bait_fish"],
    ...
    "Bigeye scad (Atlantic)": ["bait_fish", "panfish"],
    "Round scad": ["bait_fish", "panfish"],
    ...
    # West Coast sharks/rays/smelt
    "Leopard shark (Pacific)": ["game_fish"],
    "Soupfin shark": ["game_fish"],
    "Gray smoothhound": ["game_fish"],
    "Brown smoothhound": ["game_fish"],
    "Pacific electric ray": ["catch_and_release"],
    "Pacific tomcod": ["panfish"],
    "Eulachon (smelt)": ["panfish", "bait_fish"],
    "Black croaker (xieb)": ["panfish"],
    # Atlantic groundfish
    "Silver hake (whiting)": ["game_fish"],
    "Offshore hake": ["game_fish"],
    # SE/Gulf specialty
    "Atlantic tripletail": ["game_fish"],
    "Goldface tilefish": ["game_fish"],
    "Blackline tilefish": ["game_fish"],
    "Pilotfish": ["game_fish"],
    "Atlantic Spanish mackerel": ["game_fish"],
    "Longtail tuna": ["game_fish"],
    "Almaco jack": ["game_fish"],
    "Banded rudderfish": ["game_fish", "bait_fish"],
    "Bar jack": ["game_fish"],
    "African pompano": ["game_fish"],
    # Tropical reef ornamentals
    "Blue tang (Atlantic)": ["reef_fish"],
    "Ocean surgeon": ["reef_fish"],
    "Doctorfish": ["reef_fish"],
    "Foureye butterflyfish": ["reef_fish"],
    ...
    # Hawaii additions
    "Weke ula (goatfish)": ["reef_fish", "panfish"],
    "Nenue (chub)": ["panfish"],
    "Amaama (striped mullet, Hawaii)": ["panfish", "bait_fish"],
    "Kumu (squirrelfish, Hawaii)": ["reef_fish", "panfish"],
    # Pacific misc
    "Pacific whiting (hake)": ["game_fish"],
    "Blacksmith (Pacific)": ["panfish"],
    "Garibaldi (California state fish)": ["catch_and_release"],
    "Plainfin midshipman": ["panfish"],
    # NE Atlantic groundfish
    ...
    "Silver perch (Atlantic)": ["panfish", "bait_fish"],
    # Pacific salmon
    ...
    "Spiny dogfish (Pacific)": ["game_fish"],
    "Pacific angel shark": ["catch_and_release"],
    "Bat ray (Pacific)": ["game_fish"],
    "Banded guitarfish": ["panfish"],
    "Kelp bass": ["game_fish"],
    "Rock wrasse": ["panfish"],
    "Señorita wrasse": ["panfish"],
    "Walleye pollock": ["game_fish"],
    "Sablefish (Pacific)": ["game_fish"],
    "Black sea bass (Pacific)": ["catch_and_release"],
    "California corbina": ["game_fish"],
    # Atlantic/NE additions
    "Black sea bass (Atlantic)": ["game_fish"],
    "Bank sea bass": ["game_fish"],
    "Rock sea bass": ["game_fish"],
    "Spot (Atlantic)": ["panfish"],
    "Sheepshead (Atlantic)": ["game_fish"],
    "Blue catfish (tidal)": ["game_fish"],
    "Channel catfish (tidal)": ["game_fish"],
    "Skilletfish": ["panfish"],
    "Striped cusk-eel": ["panfish"],
    "Northern puffer": ["panfish"],
    # SE/Gulf reef
    "Dog snapper": ["game_fish", "reef_fish"],
    "Mahogany snapper": ["game_fish", "reef_fish"],
    ...
    # Pelagic / offshore
    "Pacific bonito": ["game_fish"],
    "Skipjack tuna (Atlantic)": ["game_fish"],
    "Little tunny (false albacore)": ["game_fish"],
    "Cobia (juvenile)": ["game_fish"],
    "Atlantic blacktip shark": ["game_fish"],
    "Spinner shark": ["game_fish"],
    "Caribbean reef shark": ["catch_and_release"],
    "Sand tiger shark": ["catch_and_release"],
    "Dusky shark": ["catch_and_release"],
    "Lemon shark": ["catch_and_release"],
    "Nurse shark": ["catch_and_release"],
    # Inshore highlights
    "Redfish (red drum) juvenile": ["game_fish"],
    "Tarpon (juvenile)": ["game_fish", "catch_and_release"],
    # West Coast additions round 2
    "Pacific spadefish": ["panfish"],
    "Pacific jack mackerel": ["panfish"],
    "Pacific barracuda": ["game_fish"],
    "Halfmoon perch": ["panfish"],
    ...
    "Steelhead (tidal)": ["game_fish"],
    "Dolly Varden (tidal)": ["game_fish"],
    # Atlantic/NE additions
    "Atlantic pollock": ["game_fish"],
    "Tautog (Mid-Atlantic)": ["game_fish"],
    "Brown shark (sandbar)": ["catch_and_release"],
    ...
    "Blacknose shark": ["catch_and_release"],
    "Yellowfin grouper": ["game_fish", "reef_fish"],
    "Wahoo (East)": ["game_fish"],
    "Sailfish (Atlantic)": ["game_fish", "catch_and_release"],
    "Dolphinfish (mahi) school": ["game_fish"],
    "Longfin albacore": ["game_fish"],
    "Bigeye tuna": ["game_fish"],
    # Inshore SE/Gulf
    ...
    "Bluefish (juvenile)": ["panfish"],
    # West Coast round 3
    "Treefish rockfish": ["panfish"],
    "Pacific halibut (small)": ["game_fish"],
    "Topsmelt": ["panfish"],
    "Sharpnose surfperch": ["panfish"],
    "Silver surfperch": ["panfish"],
    "Lingcod (small)": ["game_fish"],
    "Spiny lobster (Pacific)": ["game_fish"],
    "Pacific sierra mackerel": ["game_fish"],
    "Queenfish": ["panfish"],
    "Sargo": ["panfish"],
    "Salema": ["panfish"],
    # East Coast additions
    "Red drum (adult)": ["game_fish", "catch_and_release"],
    "Striped bass (small)": ["game_fish"],
    "Summer flounder (fluke)": ["game_fish"],
    "Cobia (adult)": ["game_fish"],
    "Ballyhoo": ["panfish"],
    "American eel": ["game_fish"],
    "Southern kingfish": ["panfish"],
    "Atlantic spadefish": ["game_fish"],
    # SE/Gulf reef
    ...
    # Batches 71-78 additions
    "Pacific anchovy": ["panfish"],
    "Walleye pollock (shore)": ["panfish"],
    "Garibaldi (protected)": ["catch_and_release"],
    "Halfmoon": ["panfish"],
    "Pollock (Atlantic surf)": ["game_fish"],
    "Tomcod (Atlantic)": ["panfish"],
    "Tautog (tog)": ["game_fish"],
    "Black sea bass (NE pier)": ["game_fish"],
    "Bergall": ["panfish"],
    "California halibut (juvenile)": ["game_fish"],
    "Pacific halibut (juvenile)": ["game_fish"],
    "Flounder (Gulf)": ["game_fish"],
    "Cobia (near-pier)": ["game_fish"],
    "Cobia (offshore)": ["game_fish"],
    "Sea bream (pinfish)": ["panfish"],
    "Sheepshead porgy": ["panfish"],
    "Atlantic spadefish (pier)": ["panfish"],
    "Mud snapper": ["panfish"],
    "Dwarf sand perch": ["panfish"],
    "Butter hamlet": ["reef_fish", "panfish"],
    ...
    # Batches 79-87
    "Dolly Varden (sea-run)": ["game_fish"],
    "Arctic char (sea-run)": ["game_fish"],
    "Pink salmon (humpback)": ["game_fish"],
    "Sockeye salmon (shore)": ["game_fish"],
    "Coho salmon (Oregon coast)": ["game_fish"],
    "Steelhead (summer run)": ["game_fish", "catch_and_release"],
    "Halibut (Alaska charter)": ["game_fish"],
    "Lingcod (Alaska)": ["game_fish"],
    "Sablefish (Alaska)": ["game_fish"],
    "Yelloweye rockfish (Alaska)": ["game_fish", "catch_and_release"],
    "Lingcod (California)": ["game_fish"],
    "Pacific halibut (large)": ["game_fish"],
    "Tarpon (Gulf Mexico)": ["game_fish", "catch_and_release"],
    "Snook (Gulf)": ["game_fish"],
    "Redfish (red drum)": ["game_fish"],
    "Redfish (surf)": ["game_fish"],
    "Redfish (flats)": ["game_fish", "catch_and_release"],
    "Speckled trout (sea trout)": ["game_fish"],
    "Speckled trout (winter)": ["game_fish"],
    "Flounder (summer)": ["game_fish"],
    "Atlantic sturgeon (catch-and-release)": ["catch_and_release"],
    "Common snook (Atlantic FL)": ["game_fish"],
    "Goliath grouper (encounter)": ["catch_and_release"],
    "Manta ray (encounter)": ["catch_and_release"],
    "Whale shark (encounter)": ["catch_and_release"],
    "Sawfish (encounter)": ["catch_and_release"],
    "Midnight parrotfish": ["reef_fish", "catch_and_release"],
    "Stoplight parrotfish": ["reef_fish", "catch_and_release"],
    "Graysby grouper": ["reef_fish", "game_fish"],
    "Cobia (Atlantic)": ["game_fish"],
    "Bluefish (large)": ["game_fish"],
    "Bluefish (snapper blues)": ["panfish"],
    "Weakfish (sea trout)": ["game_fish"],
    "Red snapper (Gulf large)": ["game_fish"],
    "Striped bass (Chesapeake)": ["game_fish"],
    "Striped bass (Hudson River)": ["game_fish"],
    "Delaware Bay weakfish": ["game_fish"],
