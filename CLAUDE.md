...
| `storage/species_images.py` | Per-species photo lookup (Wikipedia summary API, falling back to NOAA Fisheries species pages; SQLite-cached), attached to the ranked species list shown in "What's Biting" / the regs modal |
