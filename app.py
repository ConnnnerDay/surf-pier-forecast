...
SPECIES_DB: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "rig": "Carolina/fishfinder rig with very heavy wire leader and stand-up tackle",
    ...
    },
    {
        ...
        "rig": "Carolina/fishfinder rig with heavy wire leader or trolling rig",
        "hook_size": "8/0-12/0 circle hook",
    ...
    },
    {
        ...
        "rig": "Pier structure rig with small hooks and light leader",
        "hook_size": "#4-#1 circle hook",
    ...
    },
    {
        ...
        "rig": "Double-dropper rig with very small hooks or sabiki",
    ...
    },
    {
        ...
        "rig": "Double-dropper rig or Carolina rig",
        "hook_size": "#2-2/0 circle hook",
        "sinker": "2-4 oz pyramid sinker",
    ...
    # --- Additional jacks & pelagics ---
    {
        ...
        "rig": "Carolina/fishfinder rig with heavy fluorocarbon leader or vertical jig",
    ...
    },
    {
        ...
        "rig": "Pier structure rig with small hooks",
    ...
    },
    {
        ...
        "rig": "Double-dropper bottom rig with heavy weight (deep water)",
        "hook_size": "4/0-7/0 circle hook",
    ...
    },
    {
        ...
        "rig": "Double-dropper bottom rig for deep water",
        "hook_size": "3/0-6/0 circle hook",
    ...
    },
    {
        ...
        "rig": "Double-dropper rig with small hooks or float rig",
    ...
    # --- Tropical visitors & other gamefish ---
    {
        ...
        "rig": "Carolina/fishfinder rig with heavy fluorocarbon leader or free-lined",
        "hook_size": "2/0-5/0 circle hook",
    ...
    # --- Invasive & ecological awareness ---
    {
        ...
        "rig": "Double-dropper bottom rig (usually caught while reef fishing)",
        "hook_size": "#1-3/0 hook",
        "sinker": "2-4 oz bank sinker",
    ...
    },
    {
        ...
        "rig": "Double-dropper rig with shad darts or sabiki",
    ...
    # --- Additional flatfish ---
    {
        ...
        "rig": "Carolina rig with fluorocarbon leader",
    ...
    # --- Freshwater/brackish crossovers ---
    {
        ...
        "rig": "Carolina rig or Texas rig with worm hook",
    ...
    },
    {
        ...
        "rig": "Carolina/fishfinder rig or free-lined live bait",
        "hook_size": "2/0-5/0 circle hook",
        "sinker": "1-3 oz egg sinker",
    ...
    },
    {
        ...
        "rig": "Double-dropper bottom rig or jig",
    ...
    },
    {
        ...
        "rig": "Carolina/fishfinder rig with medium leader",
        "hook_size": "2/0-5/0 circle hook",
        "sinker": "3-6 oz bank sinker",
    ...
    # --- Batfish & flying gurnard ---
    {
        ...
        "rig": "Double-dropper bottom rig (incidental catch)",
        "hook_size": "#1-3/0 hook",
        "sinker": "2-4 oz pyramid sinker",
